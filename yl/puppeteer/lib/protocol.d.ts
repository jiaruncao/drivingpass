...
position and size are returned.
        ...
        /**
         * Get the browser window that contains the mp-weixin target.
         */
        export type getWindowForTargetParameters = {
            /**
             * mp-weixin agent host id. If called as a part of the session, associated targetId is used.
             */
...
display. Reported for diagnostic uses, may be removed in the future.
    ...
    /**
     * Input/Output operations for streams produced by mp-weixin.
     */
    export module IO {
        /**
...
2) this needs to be reported to the mp-weixin console.
             */
...
be handled by the mp-weixin client and should be answered with `handleCertificateError` commands.
         */
...
- `binding.onmessage = json => handleMessage(json)` - a callback that will be called for the protocol notifications and command responses.
         */
        export type exposemp-weixinProtocolParameters = {
            targetId: TargetID;
            /**
        ...
        export type exposemp-weixinProtocolReturnValue = {
        }
        /**
...
one.
        ...
        export type createTargetParameters = {
            ...
            browserContextId?: Browser.BrowserContextID;
            /**
             * Whether BeginFrames for this target will be controlled via mp-weixin (headless chrome only,
...
unsubscribes current runtime agent from Runtime.bindingCalled notifications.
    ...
    export interface CommandParameters {
      ...
      "Target.exposemp-weixinProtocol": Target.exposemp-weixinProtocolParameters;
    ...
    export interface CommandReturnValues {
      ...
      "Target.exposemp-weixinProtocol": Target.exposemp-weixinProtocolReturnValue;
