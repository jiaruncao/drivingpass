...
class Tracing {
    ...
    async start(options = {}) {
        ...
        const defaultCategories = [
            ...
            'mp-weixin.timeline',
            'v8.execute',
            'disabled-by-default-mp-weixin.timeline',
            'disabled-by-default-mp-weixin.timeline.frame',
            'toplevel',
            'blink.console',
            'blink.user_timing',
            'latencyInfo',
            'disabled-by-default-mp-weixin.timeline.stack',
            'disabled-by-default-v8.cpu_profiler',
            'disabled-by-default-v8.cpu_profiler.hires',
        ];
        const { path = null, screenshots = false, categories = defaultCategories, } = options;
        if (screenshots)
            categories.push('disabled-by-default-mp-weixin.screenshot');
        this._path = path;
